...
# Understanding data
## Loading data from CSV file 'Covid19.csv'
...
# Showing the global view of data set
library(tibble)
...
covid_df_all_states_daily <- covid_df_all_states %>% select(Date, Country_Region, active,
...
#Summarizing the data based on 'country region' column
